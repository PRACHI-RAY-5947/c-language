          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: NetworkImage("lib/assets/clock.jpg"),
                fit: BoxFit.cover,
              ),
            ),
          ),
              ...
              child: Column(
                children: [
                  ...
                  buttonRow(
                    ...
                    button: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).pushNamed(MyRoutes.calenderPage);
                      },
                      style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.black),
                      child: const Text(
                  ...
                  buttonRow(
                    btnName: "Digital Clock",
                    button: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).pushNamed(MyRoutes.digitalClock);
                      },
                      style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.black),
                      child: const Text(
                  ...
                  //           color: Colors.purple.shade50,
                  //           image: const DecorationImage(
                  //             image: NetworkImage("lib/assets/bg_image"),
                  //             fit: BoxFit.cover,
                  //           ),
                  //         ),
                  //       ),
